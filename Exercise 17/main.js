var guestList = ["Nasir", "Ali", "Junaid", "Dua", "Asma", "Ahmed"];
//print message
console.log("Unfortunately! the new dinner table will not arrive so we can invite only two guests. ");
// Remove guest from the list
while (guestList.length > 2) {
    var removeGuest = guestList.pop(); // undefined used because we don't know from guestlist which elements will be removed
